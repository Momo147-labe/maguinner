@echo off
echo ========================================
echo    BUILD WINDOWS - GESTION MAGASIN
echo ========================================
...
if not exist "build\windows\x64\runner\Release\gestion_moderne_magasin.exe" (
...
echo ========================================
echo.
echo Executable: build\windows\x64\runner\Release\gestion_moderne_magasin.exe
if exist "Output\Setup-Gestion moderne de magasin-1.0.0.exe" (
    echo Installer: Output\Setup-Gestion moderne de magasin-1.0.0.exe
)
echo.
pause